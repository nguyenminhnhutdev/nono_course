	...
	<section class="furniture_section layout_padding">
		<div class="container">
			<div class="heading_container">
				...
				<p>Khóa học với số lượng người tham gia nhiều nhất và lượt đánh giá cao nhất
				</p>
			</div>
			<div class="row">
					...
					<div class="col-sm-6 col-md-4 col-lg-3">
						<div class="info_links">
							...
							<div class="info_links_menu">
								<a class="" href="index.html">Trang chủ <span class="sr-only"></span></a>
								<a class="" href="about.html"> About</a> <a class=""
									href="furniture.html">Furniture</a> <a class=""
									href="blog.html">Blog</a> <a class="" href="contact.html">Contact
									Us</a>
							</div>
						</div>
					</div>
