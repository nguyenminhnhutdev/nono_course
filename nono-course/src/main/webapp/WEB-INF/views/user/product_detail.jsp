		...
		<div class="row px-xl-5">
				...
				<div id="product-carousel" class="carousel slide"
					...
					<div class="carousel-inner bg-light">
						<div class="carousel-item active">
							<img class="w-100 h-100" src="${showProductsById.image}" alt="Image">
						</div>
					</div>
			...
			<div class="col-lg-7 h-auto mb-30">
				<div class="h-100 bg-light p-30">
					<h3>Tên khóa học: ${showProductsById.nameCourse}</h3>
					...
					<h3 class="font-weight-semi-bold mb-4">Giá:
					
					<fmt:formatNumber type="number" pattern="###,###,###.##"
												value="${showProductsById.price}" /> VNĐ
						</h3>
					<p class="mb-4">${showProductsById.banner}</p>
							...
							<div class="row">
								<div class="col-md-6">
									<ul class="list-group list-group-flush">
										<li class="list-group-item px-0">Tác giả:
											${showProductsById.author}</li>
