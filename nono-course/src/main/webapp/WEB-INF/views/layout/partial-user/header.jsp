	...
	<div
		...
		<div class="col-lg-4">
			<a href="" class="text-decoration-none"> <span
				class="h1 text-uppercase text-primary bg-dark px-2">NOno</span>
				<span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">course</span>
			</a>
		</div>
		...
		<div class="col-lg-9">
			<nav
				...
				<a href="" class="text-decoration-none d-block d-lg-none"> <span
					class="h1 text-uppercase text-dark bg-light px-2">Multi</span>
