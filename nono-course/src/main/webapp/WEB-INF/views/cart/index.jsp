        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
				...
				value="${total + item.product.price * item.quantity }"></c:set>
                        <tr>
                            <td class="align-middle"><img src="${item.product.photo }" alt="" style="width: 50px;"></td>
                            ...
                            <fmt:formatNumber type="number" pattern="###,###,###.##"
												value="${item.product.price }" /> VNĐ
                            </td>
                            <td class="align-middle"><a href="${pageContext.request.contextPath }/cart/remove/${item.product.id }"><button class="btn btn-sm btn-danger"><i class="fa fa-times"></i></button></a></td>
                        </tr>
